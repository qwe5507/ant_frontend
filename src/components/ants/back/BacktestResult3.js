...
function BacktestResult3(props) {
    ...
    useEffect(() => {
      const temp2 = JSON.parse(props.result.replaceAll("'", '"'));
        ...
        for (var i = 0; i <  labeleurusd.length ; i++){
            ...
            finalDataChange(charteurusd[charteurusd.length-1]*10000)

        }, [props]);


        useEffect(() => {
        finalData2Change(Math.round(finalData)/100000)
    ...
    return (
                ...
                >
                    ...
                    >
                        ...
                        <Text
                            ...
                            fontFamily="ko"
                        >
                            1만 달러를 투자금으로 하였을 시 손익은 {finalData}달러이며, 최종 수익률은 {finalData2}%입니다.
                        </Text>
        ...
        {tableData.map(d => 
            <TableRow>
              ...
              <TableCell align="center">{Math.round(d["value"]*1000000)/10000}</TableCell>
...
export default BacktestResult3;