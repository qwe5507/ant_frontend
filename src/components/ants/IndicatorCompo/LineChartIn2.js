...
function LineChartIn2(props) {

    let [chartData, chartDataChange] = useState([]);

    useEffect(() => {
      IndApi.indicators2("bond10", 7)
     .then(res =>{
      var dataArr = [];
              ...
              datasets: [
                  {
                      ...
                      borderColor: "rgba(255, 80, 118, 1)",
                      borderWidth: 3,
                      backgroundColor: "rgba(255, 80, 118, 0.3)",
                      pointBackgroundColor: "rgba(255, 80, 118, 0.1)",
                      pointHoverRadius: 0,
                      pointDot: false,
                      pointRadius: 2,
                      pointDotRadius: 0,
                      pointHoverBackgroundColor: "rgba(255, 80, 118, 0.2)",
                      data: charteurusd,
                      lineTension: 0
                  }
              ]
